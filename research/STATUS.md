...
- The formulas give distinct caps 88 and 90. The first falsification task is
...
- Both formulas are fixed before \(N\) and preserve
  ...
  promise recognizer.
- No outcome at \(m=28\), later length, or asymptotic cap rate is claimed in
  this snapshot.
