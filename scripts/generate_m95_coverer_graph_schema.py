"""Generate or check the canonical M95 coverer-graph schema."""
...
from scripts.run_m95_coverer_graph_profile import build_summary
...
def main() -> int:
    ...
    if "--check" in sys.argv:
        if not SCHEMA.exists() or SCHEMA.read_text(encoding="utf-8") != rendered:
            raise SystemExit("M95 schema is stale; regenerate it")
        print("M95 coverer-graph schema: PASS")
        return 0
