"""Generate or check the canonical M98 OCT-cover schema."""
...
from scripts.run_m98_oct_cover_profile import build_summary
...
def main() -> int:
    ...
    if "--check" in sys.argv:
        if not SCHEMA.exists() or SCHEMA.read_text(encoding="utf-8") != rendered:
            raise SystemExit("M98 schema is stale; regenerate it")
        print("M98 OCT-cover schema: PASS")
        return 0
