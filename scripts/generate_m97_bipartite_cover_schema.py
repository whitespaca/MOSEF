"""Generate or check the canonical M97 bipartite-cover schema."""
...
from scripts.run_m97_bipartite_cover_profile import build_summary
...
def main() -> int:
    ...
    if "--check" in sys.argv:
        if not SCHEMA.exists() or SCHEMA.read_text(encoding="utf-8") != rendered:
            raise SystemExit("M97 schema is stale; regenerate it")
        print("M97 bipartite-cover schema: PASS")
        return 0
