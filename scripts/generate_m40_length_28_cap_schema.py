"""Generate registered M40 length-28 cap vectors."""
...
from scripts.run_m40_length_28_cap_audit import build_summary

SCHEMA = ROOT / "schemas/m40-length-28-cap-v1.json"
PRIMITIVE_CASES = (
    ("phi4", 31, 43, 91, 13633),
    ("phi4", 31, 43, 91, 11867),
    ("phi6", 59, 75, 92, 14051),
    ("phi4", 15, 99, 104, 12791),
)


def main() -> int:
    """Write the deterministic M40 schema."""
