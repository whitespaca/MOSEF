"""Generate registered M43 length-31 cap vectors."""
...
from scripts.run_m43_length_31_cap_audit import build_summary

SCHEMA = ROOT / "schemas/m43-length-31-cap-v1.json"
PRIMITIVE_CASES = (
    ("phi6", 11, 105, 144, 37483),
    ("phi6", 11, 105, 144, 44963),
    ("phi4", 91, 115, 139, 38189),
    ("phi4", 91, 115, 139, 37483),
)


def main() -> int:
    """Write the deterministic M43 schema."""
