...
The archival monograph retains all full proofs, counterexamples, and charged
branches; the M82 projection checks focused claim placement. The paper
proves results only for the displayed signed geometric-sum grammar. It
supplies no universal selector, prime-support density theorem, or general
factoring algorithm.
